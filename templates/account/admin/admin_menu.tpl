<div class="account-menu-page">
  <a href="{$BASE_URL}/pages/account/user/user_data/user_data.php"> 
  ...
  <a href="{$BASE_URL}/pages/account/user/address/address.php"> 
  ...
  <a href="{$BASE_URL}/pages/account/user/order/order.php"> 
  ...
  <a href="{$BASE_URL}/pages/account/user/password/password.php"> 
  ...
  <a href="{$BASE_URL}/pages/account/admin/admin_panel/admin_panel.php">
