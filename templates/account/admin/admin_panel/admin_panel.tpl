...
<!-- Main -->
 <div id="admin-panel">
  <a href="{$BASE_URL}/pages/account/admin/user_data/user_data.php"><div class="single-container admin-user-container"> 
  ...
  <a href="{$BASE_URL}/pages/account/admin/order/order.php"><div class="single-container admin-order-container"> 
